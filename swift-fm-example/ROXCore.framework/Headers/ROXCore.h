...
/**
 * Returns an existing `ROXCore` instance for the given `sdkKey` or `nil` if none exists.
 *
 * @param sdkKey The SDK key to look up
 * @return The existing `ROXCore` instance for the given `sdkKey` or `nil` if none exists.
 */
+ (instancetype)existingInstanceForSDKKey:(NSString *)sdkKey;
