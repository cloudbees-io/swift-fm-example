...
/**
 This class is the API for flags that are controlled by the ROX server. Flags are assigned to an experiment, and their value is based onthe  experiment container.
 */
